...
func TestRunRealtimeMultiEmitsPoints(t *testing.T) {
	...
	runRealtimeMulti(context.Background(), newRand(), fieldFns, scales, 0, 0, 0, sink, devices, 2, 1)
...
func TestRunRealtimeMultiCancellation(t *testing.T) {
	...
	runRealtimeMulti(ctx, newRand(), fieldFns, []float64{1.0}, 0, 0, 0, sink, []string{"sensor-0"}, 100, 10)
